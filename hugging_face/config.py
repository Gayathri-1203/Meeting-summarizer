...
MONGODB_INTERVIEWSCHEDUILES_COLLECTION = os.environ['MONGODB_INTERVIEWSCHEDUILES_COLLECTION']
MONGODB_JOBROLES_COLLECTION = os.environ["MONGODB_JOBROLES_COLLECTION"]
MONGODB_USERS_COLLECTION = os.environ["MONGODB_USERS_COLLECTION"]
